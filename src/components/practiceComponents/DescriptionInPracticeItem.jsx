...
const DescriptionInPracticeItem = ({ item }) => {
  return (
    <div className="w-full bg-gradient-to-br from-pink-50 to-purple-50 p-2 rounded-xl border border-pink-200 shadow-sm hover:shadow-md transition-all duration-200">
      {/* Icon and Quote Mark */}
