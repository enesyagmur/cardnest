...
const CardTemplate = () => {
  ...
  return (
    <form
      ...
      className="w-full md:w-7/12 h-[580px] bg-white/95 backdrop-blur-sm border border-gray-100 rounded-lg p-4 shadow-xl  overflow-y-auto transition-all duration-300"
    >
